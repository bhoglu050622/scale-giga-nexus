  ...
  return (
    <main className="pt-24">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-[500px] h-[400px] rounded-full bg-cyan-100/30 blur-3xl -translate-x-1/3 -translate-y-1/2" />
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] rounded-full bg-electric-100/30 blur-3xl translate-x-1/4 translate-y-1/2" />
